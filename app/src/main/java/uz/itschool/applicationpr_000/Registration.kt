...
class Registration : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_account.setOnClickListener{
            edit.putString("email", text_input_email.text.toString()).commit()
            edit.putString("password", text_input_password.text.toString()).commit()
            var i=Intent(this, CreatePinCode::class.java)
            startActivity(i)
