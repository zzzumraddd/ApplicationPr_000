...
import uz.itschool.applicationpr_000.databinding.ActivityMealProductsBinding

class MealProducts : AppCompatActivity() {
    private lateinit var binding:ActivityMealProductsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityMealProductsBinding.inflate(layoutInflater)
